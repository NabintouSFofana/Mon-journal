...
Le site est 100 % statique, léger et responsive. Il se compose principalement de :

- `index.html` — la page d’accueil du blog (présentation, articles, catégories, newsletter)
- `confidentialite.html` — la politique de confidentialité claire et simple
...
- Header fixe avec navigation fluide entre les sections
- Bloc héro avec présentation de Nabie et son univers
- Mise en avant de plusieurs articles à lire en premier
- Catégories : Foi, Lifestyle, Carrière & Tech, Santé mentale, etc.
- Sidebar avec mini-bio, rappel, catégories et inscription newsletter
- Politique de confidentialité dédiée (`confidentialite.html`)
- Mise en page responsive (mobile, tablette, desktop)
- Aucune dépendance lourde (juste HTML / CSS / JavaScript léger)
...
- HTML5
- CSS3 (sans framework)
- Vanilla JavaScript (pour quelques interactions)
